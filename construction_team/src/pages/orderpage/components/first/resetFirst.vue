...
export default {
  ...
  methods: {
    ...
    confirmReset () {
      ...
      const data = {hchoFigure, benzeneFigure, tvocFigure, ammoniaFigure, hchoStatus, benzeneStatus, tvocStatus, ammoniaStatus, examinationOneRecordId}
      ...
      vm.$http.post('/ExaminationOneConstructionTeamController/UpdateExaminationOneRecord', params)
        .then(res => {
          vm.getData()
          Toast.success('修改成功')
        })
